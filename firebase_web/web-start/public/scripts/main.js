...
function saveImageMessage(file) {
  //1. Message with a loading icon that will get updated with the uploaded image
  firebase.firestore().collection('messages').add({ //adds iamge and metadata to a 'messages' collection within Cloud Storage
    name: getUserName(),
...
function saveMessagingDeviceToken() {
  ...
  firebase.messaging().getToken().then(function(currentToken) {
    if(currentToken){
      ...
      //saving device token to the datastore
