...
(function() {
  ...
  app.getForecast = function(key, label) {
    ...
    var url = 'https://query.yahooapis.com/v1/public/yql?format=json&q=' +
        statement; //retired by Yahoo on Jan. 3, 2019
  ...
  if('serviceWorker' in navigator){ //checks if serviceWorkers are supported
    navigator.serviceWorker
      //register serviceWorker and print message in the console
